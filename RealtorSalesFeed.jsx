    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      ...
      <div className="bg-white rounded shadow p-6 space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            name="coOpAmount"
            placeholder="Co-op Paid to Buyer's Agent"
            value={form.coOpAmount}
            onChange={handleChange}
            className="w-full p-2 border rounded"
          />
          <input
            name="closingCosts"
            placeholder="Seller-Paid Closing Costs"
          ...
          <textarea
            name="comments"
            placeholder="Optional Notes (multiple offers, credits, incentives...)"
            value={form.comments}
            onChange={handleChange}
            className="w-full p-2 border rounded"
          />
